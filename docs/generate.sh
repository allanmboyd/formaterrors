...
$yuidoc_home/bin/yuidoc.py $parser_in -p $parser_out -o $generator_out -t $template -v $version -Y $yuiversion -m "formaterrors" -u "http://github.com/allanmboyd/formaterrors"
